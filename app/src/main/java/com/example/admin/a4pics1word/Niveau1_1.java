    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        app.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                raz7.setVisibility(View.INVISIBLE);
        ...
        appler.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                text4.setText("E");
                text4.setEnabled(false); app.setEnabled(false);
            }
...
////*********les image
        ...
        String laaa = preferences.getString(Niveau1_3.FAV, "00");
        ...
        SharedPreferences preferenc =getSharedPreferences("pref", 0);
        String la = preferenc.getString(Niveau1_1.bol1, "11");
