...
public class Niveau3_2 extends Activity {
    ...
    private void Trouver() {
        if (text1.getText().equals("A") && text2.getText().equals("I") && text3.getText().equals("V") && text4.getText().equals("O") && text5.getText().equals("F")) {SharedPreferences preferenc = getSharedPreferences("pref", 0);
