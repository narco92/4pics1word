...
public class Niveau2_3 extends Activity {
    ...
    private void verify() {
        if( text1.getText().equals("C") && text2.getText().equals("L") && text3.getText().equals("O") && text4.getText().equals("U") && text5.getText().equals("S"))
        {
            ...
            editor.putString(Niveau1_3.FAV, pop6);
            editor.putString(bol6, "vrai");
            editor.commit();
            Toast.makeText(Niveau2_3.this, "Bravo !", Toast.LENGTH_LONG).show();

            Intent secondeActivite = new Intent(Niveau2_3.this, ChoixNiveau.class);
            ...
            Toast.makeText(Niveau2_3.this, "Faux !", Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.niveau2_3);
        ...
        Intent f=getIntent();
        String jjj=f.getStringExtra(Niveau2_2.BUTTONS5);
        ...
        if (jjjj==60) {
            // textv2.setText("Niveau3");
            SharedPreferences preferences = getSharedPreferences("pref", 0);
            SharedPreferences.Editor editor = preferences.edit();
            editor.putString(Niveau1_3.FAV, jjjjj);
        ...
        String la = preferenc.getString(Niveau2_3.bol6, "11");
    ...
    private View.OnClickListener apple = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            raz12.setVisibility(View.INVISIBLE);
            appler.setEnabled(false);
            app.setEnabled(false);
