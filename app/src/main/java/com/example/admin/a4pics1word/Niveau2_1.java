...
public class Niveau2_1 extends Activity {
    ...
    private void verify() {
        if (text1.getText().equals("B") && text2.getText().equals("A") && text3.getText().equals("R") && text4.getText().equals("B") && text5.getText().equals("E")) {
            ...
            Toast.makeText(Niveau2_1.this, "Bravo !", Toast.LENGTH_LONG).show();

            Intent secondeActivite = new Intent(Niveau2_1.this, Niveau2_2.class);
            ...
            Toast.makeText(Niveau2_1.this, "Faux !", Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.niveau2_1);
        ...
        String laaa = preferences.getString(Niveau1_3.FAV, "11");
        ...
        SharedPreferences preferenc =getSharedPreferences("pref", 0);
        String la = preferenc.getString(Niveau2_1.bol4, "11");
    ...
    private View.OnClickListener apple = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            raz3.setVisibility(View.INVISIBLE);
