...
public class Niveau3_1 extends Activity {
    ...
    private void verify() {
        if (text1.getText().equals("A") && text2.getText().equals("F") && text3.getText().equals("C") && text4.getText().equals("D") && text5.getText().equals("Z")) {
            ...
            editor.commit();
            Toast.makeText(Niveau3_1.this, "Bravo !", Toast.LENGTH_LONG).show();
            Intent secondeActivite = new Intent(Niveau3_1.this, Niveau3_2.class);
            ...
            Toast.makeText(Niveau3_1.this, "Faux !", Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.niveau3_1);
        ...
        SharedPreferences preferenc =getSharedPreferences("pref", 0);
        String la = preferenc.getString(Niveau3_1.bol7, "11");
