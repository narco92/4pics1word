...
public class Niveau3_3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.niveau3_3);
        ...
        Intent i=getIntent();
        String jjj=i.getStringExtra(Niveau2_2.BUTTONS5);
        float jjjj= Float.valueOf(jjj);
        jjjj=jjjj+10;
        String jjjjj=String.valueOf(jjjj);
        textv.setText(jjjjj);
        if (jjjj==90) {
            //textv2.setText("Niveau4");
            SharedPreferences preferences = getSharedPreferences("pref", 0);
            SharedPreferences.Editor editor = preferences.edit();
        ...
        String la = preferenc.getString(Niveau3_3.bol9, "11");
